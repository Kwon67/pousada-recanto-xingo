    ...
    return (
      <div className="space-y-6">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1">Carregando avaliações...</p>
        </div>
      </div>
    );
  }
      ...
      >
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1">
            {avaliacoes.length} avaliações · Média: {mediaNotas}
          </p>
        </div>
        <Button
        ...
        {deleteId && (
          ...
          >
            ...
            >
              ...
              <h3 className="text-lg font-semibold text-center mb-2">Excluir avaliação?</h3>
