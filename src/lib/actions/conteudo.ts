...
const conteudoDefault: Record<string, { valor: string; categoria: string }> = {
  ...
  home_estrutura_1_media: { valor: '[]', categoria: 'home' },
  home_estrutura_2_media: { valor: '[]', categoria: 'home' },
  home_estrutura_3_media: { valor: '[]', categoria: 'home' },
  home_estrutura_4_media: { valor: '[]', categoria: 'home' },
  home_estrutura_5_media: { valor: '[]', categoria: 'home' },
